...
func TestNetIOCountersStatString(t *testing.T) {
	...
	e := `{"name":"test","bytesSent":100,"bytesRecv":0,"packetsSent":0,"packetsRecv":0,"errin":0,"errout":0,"dropin":0,"dropout":0,"fifoin":0,"fifoout":0,"linkStat":0,"activeStat":0,"isBond":false}`
